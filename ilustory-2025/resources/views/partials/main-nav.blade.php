...
<nav class="relative" style="background: #000;" x-data="{ mobileMenuOpen: false }">
    <div class="w-full px-6 mx-auto">
        <div class="flex items-center justify-between md:justify-start md:space-x-10" style="padding-top: 1rem; padding-bottom:1rem;">
            <a href="{{ home_url() }}" aria-label="Home Page">
                <img src="{{ \App\imageUrl('logo/logo-navrh.png') }}" alt="Logo {{ $siteName }}" loading="lazy"
                    style="width:12rem;">
            </a>
